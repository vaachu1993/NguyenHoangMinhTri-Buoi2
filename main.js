const products = [
  {
    ...
    price: 890,
    description:
      "High-capacity external hard drive offering fast data transfer, reliable storage, and secure backup for personal and professional use.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
  ...
  },
  {
    ...
    price: 95,
    description:
      "Bold red sneakers designed for those who love speed and style. Features advanced grip technology.",
    category: {
      id: 4,
      name: "Shoes",
      slug: "shoes",
  ...
  },
  {
    ...
    price: 110,
    description:
      "Dynamic color-block design in black and red. Built for durability and high-impact activities.",
    category: {
      id: 4,
      name: "Shoes",
      slug: "shoes",
    ...
    images: ["https://i.imgur.com/vPjonMX.png"],
  ...
  },
  {
    ...
    price: 150,
    description:
      "Stay connected and track your fitness with this sleek white smartwatch. Features heart rate monitoring, GPS, and a water-resistant design.",
    category: {
      id: 2,
      name: "Electronics",
      slug: "electronics",
  ...
  },
  {
    ...
    price: 120,
    description:
      "Experience high-fidelity sound with these over-ear wireless headphones. Noise-canceling technology and 40-hour battery life.",
    category: {
      id: 2,
      name: "Electronics",
      slug: "electronics",
    ...
    images: ["https://i.imgur.com/uAbpeVs.png"],
  ...
  },
  {
    ...
    price: 80,
    description:
      "Compact and powerful earbuds perfect for the gym or rainy commutes. IPX7 waterproof rating and seamless Bluetooth pairing.",
    category: {
      id: 2,
      name: "Electronics",
      slug: "electronics",
    ...
    images: ["https://i.imgur.com/BEZlrr6.png"],
  ...
  },
  {
    ...
    price: 18,
    description:
      "A stylish and adjustable cap in a deep indigo blue. Perfect for outdoor activities and casual outfits.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
  ...
  },
  {
    ...
    price: 18,
    description:
      "Add a pop of color to your look with this comfortable purple cap made from high-quality cotton fabric.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
    ...
    images: ["https://i.imgur.com/UaFWQbU.png"],
  ...
  },
  {
    ...
    price: 18,
    description:
      "A bold red cap with an adjustable strap. Durable, breathable, and designed for daily wear.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
    ...
    images: ["https://i.imgur.com/hrOcUSp.png"],
  ...
  },
  {
    ...
    price: 25,
    description:
      "A crisp, clean white t-shirt made from premium cotton. A staple piece for any minimalist wardrobe.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
    ...
    images: ["https://i.imgur.com/A30Jtpr.png"],
  ...
  },
  {
    ...
    price: 25,
    description:
      "Classic black t-shirt with a modern fit. Soft to the touch and resistant to multiple washes.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
    ...
    images: ["https://i.imgur.com/Yhq2VNz.png"],
  ...
  },
  {
    ...
    price: 130,
    description:
      "Experience pure sound with this elegant white wireless headset. Ergonomic design with long-lasting battery life and crystal-clear audio.",
    category: {
      id: 2,
      name: "Electronics",
      slug: "electronics",
    ...
    images: ["https://i.imgur.com/rkQ9fs3.png"],
  ...
  },
  {
    ...
    price: 40,
    description:
      "Keep your gear dry and organized with this durable, waterproof blue gym bag. Features multiple compartments and a comfortable shoulder strap.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
  ...
  },
  {
    ...
    price: 40,
    description:
      "High-visibility red gym bag made from waterproof material. Perfect for the gym, swimming, or outdoor adventures.",
    category: {
      id: 1,
      name: "Clothes",
      slug: "clothes",
    ...
    images: ["https://i.imgur.com/aMkyLvm.png"],
